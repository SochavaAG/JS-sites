...
function parallaxScroll(){
   ...
   // bkgdParallaxTwo("ComingSoon",0)
    bkgdParallaxOne("One",0)
    bkgdParallaxTwo("Two",0)
    bkgdParallaxThree("Three",0)
    bkgdParallaxFour("Four",0)
    bkgdParallax("Five",0)
	...
	function bkgdParallaxOne(bkgdNum,topNumAdj){

		var secDynScroll = eval("sec"+bkgdNum+"Scroll")
		var directThis = "left"

		$("#section"+bkgdNum+" .bgZero").css(directThisTop,(secDynScroll*.2+(scrolled*.2))+"px");
		$("#section"+bkgdNum+" .bgOne").css("right",(secDynScroll*.1+(scrolled*.1))+"px");
		$("#section"+bkgdNum+" .bgTwo").css(directThis,(secDynScroll*.25+(scrolled*.25))+"px");
		$("#section"+bkgdNum+" .bgThree").css("right",(secDynScroll*.5+(scrolled*.5))+"px");
		$("#section"+bkgdNum+" .bgFour").css(directThis,(secDynScroll*.75+(scrolled*.75))+"px");
	...
	function bkgdParallaxTwo(bkgdNum,topNumAdj){
		...
		$("#section"+bkgdNum+" .bgNegOne").css(directThis,(secDynScroll*.05+(scrolled*.05))+"px");
		$("#section"+bkgdNum+" .bgZero").css(directThisTop,(secDynScroll*.2+(scrolled*.2))+"px");
		$("#section"+bkgdNum+" .bgOne").css(directThis,(secDynScroll*.1+(scrolled*.1))+"px");
		$("#section"+bkgdNum+" .bgTwo").css("right",(secDynScroll*.25+(scrolled*.25))+"px");
		$("#section"+bkgdNum+" .bgThree").css(directThis,(secDynScroll*.1+(scrolled*.1))+"px");
		$("#section"+bkgdNum+" .bgFour").css(directThis,(secDynScroll*.5+(scrolled*.5))+"px");
		$("#section"+bkgdNum+" .bgFive").css(directThis,(secDynScroll*.75+(scrolled*.75))+"px");
	...
	function bkgdParallaxThree(bkgdNum,topNumAdj){
		...
		$("#section"+bkgdNum+" .bgNegOne").css(directThis,(secDynScroll*.05+(scrolled*.05))+"px");
		$("#section"+bkgdNum+" .bgZero").css(directThis,(secDynScroll*.1+(scrolled*.1))+"px");
		$("#section"+bkgdNum+" .bgOne").css(directThis,(secDynScroll*.25+(scrolled*.25))+"px");
		$("#section"+bkgdNum+" .bgTwo").css(directThis,(secDynScroll*.5+(scrolled*.5))+"px");
		$("#section"+bkgdNum+" .bgThree").css(directThis,(secDynScroll*.75+(scrolled*.75))+"px");
		$("#section"+bkgdNum+" .bgFour").css(directThisTop,(secDynScroll*.5+(scrolled*.5))+"px");
		$("#section"+bkgdNum+" .bgFive").css(directThisTop,(secDynScroll*.4+(scrolled*.4))+"px");
		$("#section"+bkgdNum+" .bgSix").css(directThisTop,(secDynScroll*.5+(scrolled*.5))+"px");
		$("#section"+bkgdNum+" .bgSeven").css(directThisTop,(secDynScroll*.4+(scrolled*.4))+"px");

	}
	function bkgdParallaxFour(bkgdNum,topNumAdj){
		...
		$("#section"+bkgdNum+" .bgTwo").css(directThis,(secDynScroll*.25+(scrolled*.25))+"px");
		$("#section"+bkgdNum+" .bgThree").css(directThis,(secDynScroll*.1+(scrolled*.1))+"px");
		$("#section"+bkgdNum+" .bgFour").css(directThis,(secDynScroll*.3+(scrolled*.3))+"px");
		$("#section"+bkgdNum+" .bgFive").css(directThis,(secDynScroll*.75+(scrolled*.75))+"px");
...
$(".navclick").click(function(e) {
	...
	$("#mainLogo").animate({ opacity: "0"}, TimeAmount/4, "easeOutQuad");
