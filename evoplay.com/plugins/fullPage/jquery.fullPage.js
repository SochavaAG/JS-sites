		...
		*/
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				$(this).find('.fp-slidesContainer').css('width', '100%');

/* Disabled Flex Slides Navigation Arrows
...
/*
        var $fpSlideNav = $('.fp-slidesNav', '.fp-section.active');
		...
		*/
		...
		function resizeMe(displayHeight, displayWidth) {
			...
			if (displayHeight < 825 || displayWidth < 900) {
				...
				var percentage = (windowSize * 100) / preferredHeight;
				var newFontSize = percentage.toFixed(2) * 0.9;
